                        ...
                        <div className='bg-white border border-gray-200 rounded-xl p-6'>
                            ...
                            {flowData.canvasType === 'business-model' && (
                                <div className='grid grid-cols-3 gap-3 min-h-[400px]'>
                                    ...
                                    <div
                                        className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${
                                            selectedSection === 'key-activities'
                                                ? 'border-blue-500 bg-blue-50'
                                                : 'border-gray-200 hover:border-gray-300'
                                        }`}
                                    ...
                                    <div
                                        className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${
                                            selectedSection === 'value-propositions'
                                                ? 'border-blue-500 bg-blue-50'
                                                : 'border-gray-200 hover:border-gray-300'
                                        }`}
                                    ...
                                    <div className='flex flex-col gap-3'>
                                        <div
                                            className={`p-3 border-2 rounded-lg cursor-pointer transition-all flex-1 ${
                                                selectedSection === 'customer-relationships'
                                                    ? 'border-blue-500 bg-blue-50'
                                                    : 'border-gray-200 hover:border-gray-300'
                                            }`}
                                    ...
                                    <div
                                        className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${
                                            selectedSection === 'customer-segments'
                                                ? 'border-blue-500 bg-blue-50'
                                                : 'border-gray-200 hover:border-gray-300'
                                        }`}
                                    ...
                                    <div
                                        className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${
                                            selectedSection === 'cost-structure'
                                                ? 'border-blue-500 bg-blue-50'
                                                : 'border-gray-200 hover:border-gray-300'
                                        }`}
                                    ...
                                    <div className='col-span-2'>
                                        <div
                                            className={`p-4 border-2 rounded-lg cursor-pointer transition-all h-full ${
                                                selectedSection === 'revenue-streams'
                                                    ? 'border-blue-500 bg-blue-50'
                                                    : 'border-gray-200 hover:border-gray-300'
                                            }`}
                            ...
                            {flowData.canvasType === 'lean' && (
                                <div className='grid grid-cols-3 gap-3 min-h-[400px]'>
                                    ...
                                    <div
                                        className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${
                                            selectedSection === 'unique-value-proposition'
                                                ? 'border-blue-500 bg-blue-50'
                                                : 'border-gray-200 hover:border-gray-300'
                                        }`}
                            ...
                            {selectedSection ? (
                                ...
                                <div className='text-center py-8'>
                                    ...
                                    <p className='text-sm text-gray-500'>
                                        Click on any section in the canvas to configure its AI instructions and feedback rules.
                                    </p>
                                </div>
                            )}
                        </div>
