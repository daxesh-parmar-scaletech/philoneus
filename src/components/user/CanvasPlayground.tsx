...
export default function CanvasPlayground() {
  ...
  const generateAISuggestion = (sectionId: string, content: string) => {
    ...
    setAiSuggestion(suggestions[sectionId as keyof typeof suggestions] || 'Great start! Consider adding more specific details to make this section more compelling.');
  };
              ...
              {selectedSection ? (
                ...
                <div className="text-center py-6">
                  ...
                  <p className="text-sm text-gray-500">
                    Click on any canvas section to get AI-powered suggestions and feedback.
                  </p>
                </div>
              )}
