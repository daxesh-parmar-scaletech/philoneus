...
export default function UserLanding() {
  ...
  const handleStartSession = () => {
    ...
    navigate(`/flow/${shareId}/questions`);
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="px-8 py-12">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Leading expert in innovation management and future affairs with over 15 years of experience 
                    helping organizations navigate digital transformation and AI integration. Trusted advisor to 
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mt-4">
                No signup required • Takes 10-15 minutes • Instant results
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-500">
            Join {flow.completions}+ professionals who have already completed this assessment
          </p>
        </div>
      </div>
    </div>
